...
control '2.2.2_L1_Ensure_Access_this_computer_from_the_network_is_set_to_Administrators_Authenticated_Users_ENTERPRISE_DOMAIN_CONTROLLERS_DC_only' do
  ...
  impact 1.0
  tag cce: 'CCE-35818-4'
  permitted_principals = ['BUILTIN\\Administrators', 'NT AUTHORITY\\Authenticated Users', 'NT AUTHORITY\\ENTERPRISE DOMAIN CONTROLLERS']
  describe security_policy(translate_sid: true).SeNetworkLogonRight | permitted_principals do
...
control '2.2.5_L1_Ensure_Add_workstations_to_domain_is_set_to_Administrators_DC_only' do
  ...
  describe security_policy(translate_sid: true) do
    its('SeMachineAccountPrivilege') { should match_array ['BUILTIN\\Administrators'] }
  end
end
...
control '2.2.6_L1_Ensure_Adjust_memory_quotas_for_a_process_is_set_to_Administrators_LOCAL_SERVICE_NETWORK_SERVICE' do
  ...
  describe security_policy(translate_sid: true).SeIncreaseQuotaPrivilege | permitted_principals do
    it { should match_array permitted_principals }
  end
end
...
control '2.2.8_L1_Ensure_Allow_log_on_through_Remote_Desktop_Services_is_set_to_Administrators_DC_only' do
  ...
  tag cce: 'CCE-37072-6'
  describe security_policy(translate_sid: true) do
    its('SeRemoteInteractiveLogonRight') { should match_array ['BUILTIN\\Administrators'] }
  end
end
...
control '2.2.11_L1_Ensure_Change_the_system_time_is_set_to_Administrators_LOCAL_SERVICE' do
  ...
  describe security_policy(translate_sid: true).SeSystemtimePrivilege | permitted_principals do
    it { should match_array permitted_principals }
  end
end
...
control '2.2.12_L1_Ensure_Change_the_time_zone_is_set_to_Administrators_LOCAL_SERVICE' do
  ...
  tag cce: 'CCE-37700-2'
  permitted_principals = ['BUILTIN\\Administrators', 'NT AUTHORITY\\LOCAL SERVICE']
  describe security_policy(translate_sid: true).SeTimeZonePrivilege | permitted_principals do
    it { should match_array permitted_principals }
  end
end
...
control '2.2.15_L1_Ensure_Create_global_objects_is_set_to_Administrators_LOCAL_SERVICE_NETWORK_SERVICE_SERVICE' do
  ...
  describe security_policy(translate_sid: true).SeCreateGlobalPrivilege | permitted_principals do
    it { should match_array permitted_principals }
  end
end
...
control '2.2.17_L1_Ensure_Create_symbolic_links_is_set_to_Administrators_DC_only' do
...
control '2.2.20_L1_Ensure_Deny_access_to_this_computer_from_the_network_is_set_to_Guests_DC_only' do
  title "(L1) Ensure 'Deny access to this computer from the network' is set to 'Guests' (DC only)"
  desc  "
...
control '2.2.25_L1_Ensure_Deny_log_on_through_Remote_Desktop_Services_is_set_to_Guests_DC_only' do
  title "(L1) Ensure 'Deny log on through Remote Desktop Services' is set to 'Guests' (DC only)"
  desc  "
    ...
    The recommended state for this setting is: Guests.
...
control '2.2.27_L1_Ensure_Enable_computer_and_user_accounts_to_be_trusted_for_delegation_is_set_to_Administrators_DC_only' do
  ...
  tag cce: 'CCE-36860-5'
  describe security_policy(translate_sid: true) do
    its('SeEnableDelegationPrivilege') { should match_array ['BUILTIN\\Administrators'] }
  end
end
...
control '2.2.30_L1_Ensure_Generate_security_audits_is_set_to_LOCAL_SERVICE_NETWORK_SERVICE' do
  ...
  describe security_policy(translate_sid: true).SeAuditPrivilege | permitted_principals do
    it { should match_array permitted_principals }
  end
end

control '2.2.31_L1_Ensure_Impersonate_a_client_after_authentication_is_set_to_Administrators_LOCAL_SERVICE_NETWORK_SERVICE_SERVICE_DC_only' do
  ...
  tag cce: 'CCE-37106-2'
  permitted_principals = ['BUILTIN\\Administrators', 'NT AUTHORITY\\LOCAL SERVICE', 'NT AUTHORITY\\NETWORK SERVICE', 'NT AUTHORITY\\SERVICE']
  describe security_policy(translate_sid: true).SeImpersonatePrivilege | permitted_principals do
    it { should match_array permitted_principals }
  end
end
...
control '2.2.37_L1_Ensure_Manage_auditing_and_security_log_is_set_to_Administrators_and_when_Exchange_is_running_in_the_environment_Exchange_Servers_DC_only' do
...
control '2.2.44_L1_Ensure_Replace_a_process_level_token_is_set_to_LOCAL_SERVICE_NETWORK_SERVICE' do
  ...
  tag cce: 'CCE-37430-6'
  permitted_principals = ['NT AUTHORITY\\LOCAL SERVICE', 'NT AUTHORITY\\NETWORK SERVICE']
  describe security_policy(translate_sid: true).SeAssignPrimaryTokenPrivilege | permitted_principals do
    it { should match_array permitted_principals }
  end
end
...
control '2.2.47_L1_Ensure_Synchronize_directory_service_data_is_set_to_No_One_DC_only' do
  title "(L1) Ensure 'Synchronize directory service data' is set to 'No One' (DC only)"
  desc  "
...
control '2.3.5.1_L1_Ensure_Domain_controller_Allow_server_operators_to_schedule_tasks_is_set_to_Disabled_DC_only' do
...
control '2.3.5.2_L1_Ensure_Domain_controller_LDAP_server_signing_requirements_is_set_to_Require_signing_DC_only' do
...
control '2.3.5.3_L1_Ensure_Domain_controller_Refuse_machine_account_password_changes_is_set_to_Disabled_DC_only' do
...
control '2.3.6.5_L1_Ensure_Domain_member_Maximum_machine_account_password_age_is_set_to_30_or_fewer_days_but_not_0' do
  ...
  describe registry_key('HKEY_LOCAL_MACHINE\\System\\CurrentControlSet\\Services\\Netlogon\\Parameters') do
    ...
    its('MaximumPasswordAge') { should > 0 }
  end
  describe registry_key('HKEY_LOCAL_MACHINE\\System\\CurrentControlSet\\Services\\Netlogon\\Parameters') do
    it { should have_property 'MaximumPasswordAge' }
...
control '2.3.10.6_L1_Configure_Network_access_Named_Pipes_that_can_be_accessed_anonymously_DC_only' do
  ...
  impact 1.0
  tag cce: 'CCE-38258-0'
  describe registry_key('HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\LanManServer\\Parameters').NullSessionPipes&.reject { |value| value =~ /^((LSARPC)|(NETLOGON)|(SAMR))$/ } || [] do
    it { should be_empty }
  end
end
