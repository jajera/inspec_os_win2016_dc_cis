...
control '17.2.3_L1_Ensure_Audit_Distribution_Group_Management_is_set_to_Success_and_Failure_DC_only' do
  title "(L1) Ensure 'Audit Distribution Group Management' is set to 'Success and Failure' (DC only)"
  desc  "
...
control '17.4.1_L1_Ensure_Audit_Directory_Service_Access_is_set_to_Success_and_Failure_DC_only' do
  title "(L1) Ensure 'Audit Directory Service Access' is set to 'Success and Failure' (DC only)"
  desc  "
...
control '17.4.2_L1_Ensure_Audit_Directory_Service_Changes_is_set_to_Success_and_Failure_DC_only' do
  title "(L1) Ensure 'Audit Directory Service Changes' is set to 'Success and Failure' (DC only)"
  desc  "
